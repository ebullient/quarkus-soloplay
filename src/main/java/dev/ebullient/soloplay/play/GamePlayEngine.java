...
public class GamePlayEngine {
    ...
    private GameResponse handleTurn(GameState game, String playerInput, GameEventEmitter emitter) {
        ...
        List<String> theParty = List.of(); // gameRepository.findProtagonists(game.getGameId())
        String locationName = game.getCurrentLocation();
        String sceneContext = null; // recent narrative from chat history?
    ...
    private GameResponse resolveRoll(GameState game, PendingRollDraft pending, String rollInput,
        ...
        // TODO: gather context
        String protagonist = ""; // current player character summary
        String locationName = game.getCurrentLocation();
    ...
    public GameResponse sceneStart(GameState game, GameEventEmitter emitter) {
        ...
        List<String> theParty = List.of(); // TODO: fetch protagonists
    ...
    public GameResponse recap(GameState game, String recentEvents, String currentSituation,
            GameEventEmitter emitter) {
